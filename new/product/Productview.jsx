            ...
            {product.map((value, index) => {
              return (
                <TableRow key={index}>
                  ...
                  <TableCell>{value.Expiredate}</TableCell>
                  <TableCell>{value.prod[0].Categoryname}</TableCell>
                  <TableCell> <img src={`data:image/jpeg;base64,${Buffer.from(value.Photo.data)}`}  style={{ height:'40px' ,width: '100px'}} alt='Error' /></TableCell>
